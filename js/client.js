(function() {
    var k, m = this, n = function(a) {
        return void 0 !== a
    }, aa = function() {}, p = function(a) {
        var b = typeof a;
        if ("object" == b)
            if (a) {
    ...
    var qa = B("Opera"), C = B("Trident") || B("MSIE"), ra = B("Edge"), D = B("Gecko") && !(la() && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"), E = la() && !B("Edge"), sa = function() {
        var a = A;
        if (D)
            return /rv\:([^\);]+)(\)|;)/.exec(a);
        if (ra)
    ...
    var I = function(a, b) {
        ...
        if (a) {
            ...
            if (c = a.relatedTarget) {
                ...
                "mouseover" == b ? c = a.fromElement : "mouseout" == b && (c = a.toElement);
            this.relatedTarget = c;
            null === d ? (this.offsetX = E || void 0 !== a.offsetX ? a.offsetX : a.layerX,
    ...
    K.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Oa(a, b, d, e);
        -1 < g ? (b = a[g],
        c || (b.D = !1)) : (b = new Ma(b,this.src,f,!!d,e),
        b.D = c,
        a.push(b));
        return b
    }
    ...
    K.prototype.remove = function(a, b, c, d) {
        ...
        Na(c),
        c = e,
        Array.prototype.splice.call(c, b, 1),
    ...
    var Oa = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.A && f.listener == b && f.capture == !!c && f.G == d)
                return e
        }
        return -1
    };
    var Qa = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , L = function(a, b, c, d, e) {
        if ("array" == p(b))
            ...
            c = Ta(c),
            a && a[J] ? a.j.add(String(b), c, !1, d, e) : Ua(a, b, c, !1, d, e)
    }
      ...
      , Ya = function(a, b, c, d, e) {
        if ("array" == p(b))
            ...
            c = Ta(c),
            a && a[J] ? a.j.add(String(b), c, !0, d, e) : Ua(a, b, c, !0, d, e)
    }
      , Za = function(a, b, c, d, e) {
        if ("array" == p(b))
            ...
            c = Ta(c),
            a && a[J] ? a.j.remove(String(b), c, d, e) : a && (d = !!d,
            (a = M(a)) && (b = a.Z(b, c, d, e)) && $a(b))
    }
      , $a = function(a) {
            ...
            if ("object" == typeof b) {
                if ("array" == p(b)) {
                    ...
                    for (var e = "", f = 0; f < b; f++)
                        c.push(e),
                        e = a[f],
                        ib(d, d.N ? d.N.call(a, String(f), e) : e, c),
                        e = ",";
                    c.push("]");
                    return
                }
    ...
    var nb = null
      , pb = function() {
        ...
        if (b.body) {
            var c;
            try {
                c = b.createElement('<iframe name="' + a + '" id="' + a + '" src="about:blank" style="height: 0px; width: 0px; display:none">'),
            ...
            b.write("<iframe frameBorder='0' src='about:blank' id='" + a + "' name='" + a + "' style='height:0px;width:0px;display:none'></iframe>")
    }
      , qb = function(a) {
        a = a.X;
        if (G().top == a.source) {
    ...
    O.prototype.dispatchEvent = function(a) {
        ...
        var e = !0, f;
        if (b)
            for (var g = b.length - 1; !a.w && 0 <= g; g--)
                f = a.currentTarget = b[g],
                e = P(f, d, !0, a) && e;
        a.w || (f = a.currentTarget = c,
        e = P(f, d, !0, a) && e,
        a.w || (e = P(f, d, !1, a) && e));
        if (b)
            for (g = 0; !a.w && g < b.length; g++)
                f = a.currentTarget = b[g],
                e = P(f, d, !1, a) && e;
        return c = e
    }
    ...
    var Eb = function(a, b) {
        ...
        if (-1 != String(m.Promise).indexOf("[native code]")) {
            ...
            R = function() {
                ...
                a && (e = t(d, a));
                e = xb(e);
                !r(m.setImmediate) || !c && m.Window && m.Window.prototype && !B("Edge") && m.Window.prototype.setImmediate == m.setImmediate ? (vb || (vb = wb()),
                vb(e)) : m.setImmediate(e)
            }
    }, Cb = !1, Db = new yb, Fb = function() {
        ...
        if (0 == a.O) {
            ...
            a: {
                ...
                if (l)
                    ...
                    l = typeof e;
                    if (l = "object" == l && null != e || "function" == l)
                        try {
                            var w = e.then;
                            if (r(w)) {
                                Lb(e, w, f, g, h);
    ...
    S.prototype.Ha = function() {
        if (this.enabled) {
            var a = u() - this.$;
            0 < a && a < .8 * this.I ? this.o = this.R.setTimeout(this.V, this.I - a) : (this.o && (this.R.clearTimeout(this.o),
            this.o = null),
            this.dispatchEvent("tick"),
            this.enabled && (this.o = this.R.setTimeout(this.V, this.I),
            this.$ = u()))
        }
    }
    ;
    S.prototype.start = function() {
        this.enabled = !0;
        this.o || (this.o = this.R.setTimeout(this.V, this.I),
        this.$ = u())
    }
    ;
    ...
    var T = null
      ...
      , ac = function() {
        if (!T) {
            ...
            Xb = {};
            for (var a = 0; 65 > a; a++)
                T[a] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a),
                U[T[a]] = a,
                Xb[a] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(a),
    ...
    var W = function(a, b, c) {
        ...
        b = a.a[0];
        c = a.a[1];
        for (var g = a.a[2], h = a.a[3], l = a.a[4], w, e = 0; 80 > e; e++)
            40 > e ? 20 > e ? (f = h ^ c & (g ^ h),
            w = 1518500249) : (f = c ^ g ^ h,
            w = 1859775393) : 60 > e ? (f = c & g | h & (c | g),
            w = 2400959708) : (f = c ^ g ^ h,
            w = 3395469782),
            f = (b << 5 | b >>> 27) + f + l + w + d[e] & 4294967295,
            l = h,
            h = g,
    ...
    X.prototype.set = function(a, b, c, d, e, f) {
        ...
        d = d ? ";path=" + d : "";
        f = f ? ";secure" : "";
        0 > c ? c = "" : (c = 0 == c ? new Date(1970,1,1) : new Date(u() + 1E3 * c),
    ...
    var Z = null
      ...
      , lc = function() {
        var a = kc(), b;
        var c = kc();
        c && c.tsl ? (b = eb().unloadEventStart,
        N(),
        c = c.tsl,
        b = b && c >= b ? !0 : 8 >= hc - c) : b = !1;
        a: {
            c = jc(document.URL);
            if (Z)
        ...
        d = kc();
        d = !!d && 0 < d.nv;
        (b = b && !c && !d) && a && a.upt ? a = a.upt : (a = Rb,
        b = eb().domLoading,
        a = null != b ? b : null != a ? a : N());
        return a
    }
      , mc = function() {
        var a = null;
        ...
        if (Y.isEnabled()) {
            ...
            if (c) {
                ...
                for (e = 0; e < c.length; e++)
                    if (c[e].u == b || 600 <= d - c[e].tsl)
                        c.splice(e, 1),
                        e--;
                b = c
            }
            a && b.unshift(a);
            var b = b.slice(0, 3), f, a = f = (new hb(f)).C(b);
            f = !0;
            if (Zb && !f)
                f = m.btoa(a);
            else {
    ...
    var oc = function() {
        ...
        if (!(window.ima && window.ima.video && window.ima.video.client && window.ima.video.client.tagged)) {
            ...
            v("ima.video.client.resetEDForTesting", Vb);
